...
//  ClaimsInvestigation
//
//  Created by Vivek Saini on 12/10/18.
...
open class LinearProgressBar: UIView {
    ...
    //PUBLIC VARS
    open var backgroundProgressBarColor: UIColor = UIColor.lightGray
    open var progressBarColor: UIColor = ColorConstant.kThemeColor
    ...
    override public init(frame: CGRect) {
        ...
        self.progressBarIndicator = UIView(frame: CGRect(origin: CGPoint(x: 0.0,y :0.0), size: CGSize(width: frame.size.width, height: heightForLinearBar)))
        
        widthForLinearBar = frame.size.width
    }
